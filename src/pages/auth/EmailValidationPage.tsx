...
export function EmailValidationPage() {
  ...
  return (
    <AuthLayout title="Verify your email" subtitle="We sent a confirmation link when you signed up. Enter your email to resend it.">
      {sent ? (
        <div className="text-center py-6 animate-scale-in">
          ...
          <h3 className="font-display text-lg font-semibold">Confirmation link sent</h3>
          <p className="mt-2 text-sm" style={{ color: 'var(--text-soft)' }}>
            Check <span className="font-medium" style={{ color: 'var(--text)' }}>{email}</span> and click the link to verify your account.
          </p>
